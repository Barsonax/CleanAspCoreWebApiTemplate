    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Bow_Damage = table.Column<float>(type: "real", nullable: true),
                Bow_RateOfFire = table.Column<float>(type: "real", nullable: true),
                Damage = table.Column<float>(type: "real", nullable: true),
                RateOfFire = table.Column<float>(type: "real", nullable: true)
            },
            constraints: table =>
            {
